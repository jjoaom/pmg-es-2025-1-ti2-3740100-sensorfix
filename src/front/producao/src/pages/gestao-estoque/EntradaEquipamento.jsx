...
export default function EntradaEquipamento() {
    ...
    const handleEntrada = async () => {
        ...
        const novaQtd = parseInt(equipamento.quantidade, 10) + parseInt(entrada, 10);
        try {
            await api.put(`/equipamentos/${equipamento.id}`, { ...equipamento, quantidade: novaQtd });
    ...
    const handleCadastrarEquipamento = async (novoEquipamento) => {
        try {
            ...
            setAlert({ message: "Equipamento cadastrado com sucesso.", type: "success" });
            setShowCadastro(false);
        } catch {
