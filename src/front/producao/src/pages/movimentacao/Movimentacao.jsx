    ...
    return (
      ...
      <div className="container-fluid py-0 position-relative">
        ...
        <aside className="col-lg-2 col-md-3 d-none d-md-block">
            <div className="card glass-div rounded p-3 d-flex align-items-stretch" style={{ minWidth: 180 }}>
                <nav>
                    <ul className="list-unstyled">
                        {["Ativação", "Ativo", "Danificado", "Estoque", "Manutenção"].map((label) => (
                    ...
                    <form>
                        <div className="row g-3 align-items-end">
                            <div className="col-md-3">
                                <label className="form-label" htmlFor="filtro-item">Item</label>
                                <input
                                    id="filtro-item"
                                    type="text"
                            ...
                            <div className="col-md-3">
                                <label className="form-label" htmlFor="filtro-deposito">Depósito</label>
                                <select
                                    id="filtro-deposito"
                            ...
                            <div className="col-md-3">
                                <label className="form-label" htmlFor="filtro-periodo">Período</label>
                                <input
                                    id="filtro-periodo"
                                    type="date"
                                    className="form-control"
                            ...
                            <div className="col-md-2">
                                <button type="button" className="btn btn-design btn-primary w-100">
                                    Nova movimentação
                                </button>
                            </div>
                        </div>
